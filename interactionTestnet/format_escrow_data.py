...
if type == 'send':
    with open(os.getcwd() + '/elrond-escrow/interactionTestnet/getSendData.json', 'r') as f:
        data = json.load(f)
    f = open(os.getcwd() + '/elrond-escrow/interactionTestnet/SEND-' + address + '.txt', 'w+')
if type == 'receive':
    with open(os.getcwd() + '/elrond-escrow/interactionTestnet/getReceiveData.json', 'r') as f:
        data = json.load(f)
    f = open(os.getcwd() + '/elrond-escrow/interactionTestnet/RECEIVE-'  + address + '.txt', 'w+')
